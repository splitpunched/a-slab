const items = {
	...
	modules: {
		...
		ship: {
			...
			getters: {
				isIncentivized: (state, getters, rootState, rootGetters) => { return rootGetters.flagset.shuffleFetchItems },
				isConsumable: () => { return false },
				canDisplay: () => { return true },
				isUsable: () => { return false },
				isLinked: (state, getters, rootState, rootGetters) => { return !rootGetters.flagset.shuffleNPCItems },
		...
		bottle: {
			...
			state: {
				...
				name: "bottle",
				label: "Bottle",
				image: { default: 'bottle.png', activated: 'bottle-activated.png', },
				keyItem: true,
		...
		slab: {
			...
			state: {
				...
				name: "slab",
				label: "Slab",
				image: { default: 'slab.png', activated: 'slab-activated.png', },
				keyItem: true,
		...
		powerGauntlet: {
			...
			getters: {
				isIncentivized: (state, getters, rootState, rootGetters) => { return rootGetters.flagset.incentiveOffCastArmor },
				canDisplay: (state, getters, rootState, rootGetters) => { return getters.isIncentivized },
				isConsumable: () => { return false },
				isUsable: () => { return false },
				isLinked: () => { return false },
